...
### Technical details
This formalization has been carried using Coq 8.18. The project can be rebuilt at once using `dune build`, with [Ocaml](https://ocaml.org/docs/installing-ocaml) 5.3 and [Dune](https://dune.build/install) 3.8. Using opam, both can be installed with:
```shell
